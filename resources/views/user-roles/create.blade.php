...
@section('htmlheader_title')
    {{ trans('adminlte_lang::message.userroles') }} - {{ trans('adminlte_lang::message.creation') }}
@endsection

@section('contentheader_title')
    {{ trans('adminlte_lang::message.userroles') }} <small>{{ trans('adminlte_lang::message.creation') }}</small>
@endsection

@section('breadcrumbs')
    {!! Breadcrumbs::render('user-roles.create') !!}
@endsection
